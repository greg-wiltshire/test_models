...
class Main(trac.TracModel):
    ...
    def run_model(self, ctx: trac.TracContext):
        ...
        #############################################################################################
        #                               UK Corporate portfolio calculation                          #
        #############################################################################################
        ...
        # Output the datasets
        ctx.put_pandas_table("uk_corporate_pd_term_structures", corporate_pd_term_structures)


if __name__ == "__main__":
    import tracdap.rt.launch as launch

    launch.launch_model(Main, "wholesale_ifrs9/config/generate_pd_curves_for_uk_corporate_portfolio.yaml", "wholesale_ifrs9/config/sys_config.yaml")
